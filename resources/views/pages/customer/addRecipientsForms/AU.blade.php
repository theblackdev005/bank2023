<div>
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-6 pt-m">
                ...
                <div class="form-group">
                    <input type="text" autocapitalize="none" placeholder="000000000" autocomplete="nope" autocorrect="off" class="form-control input-lg" name="account_number" required>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6 pt-m">
                <label>{{ translate(615) }}</label>
                <div class="form-group">
                  <input type="text" autocapitalize="none" placeholder="000-000" autocomplete="nope" autocorrect="off" class="form-control input-lg" name="bsb_code" required>
                </div>
            </div>
        </div>
    </div>
