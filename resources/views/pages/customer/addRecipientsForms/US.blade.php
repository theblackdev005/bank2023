<div>
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-6 pt-m">
                ...
                <div class="form-group">
                  <input type="text" autocapitalize="none" placeholder="0000000000" autocomplete="nope" autocorrect="off" class="form-control input-lg" id="account_number" name="account_number" required>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6 pt-m">
                <label>{{ translate(604) }}</label>
                <div class="form-group">
                  <input type="text" autocapitalize="none" placeholder="000000000" autocomplete="nope" autocorrect="off" class="form-control input-lg" id="routing_number" name="routing_number" required>
                </div>
            </div>
        </div>
    </div>
