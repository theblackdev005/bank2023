			...
			<div class="tab-content" id="pills-tabContent">
				<div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
					...
					@else
						...
						@php
							$paid_fee = $pending_transfert_fees["finish"]->last()
						@endphp

						@if ( $paid_fee )
							
							{{-- <form id="withdraw-send-money" class="form bg-offwhite py-4" onsubmit="return false;">
								...
								<x-transfer-stats
									:data=$pending_transfert
									percentage="{{ $paid_fee->percentage }}" />

								<x-transfer-success-code :fee=$paid_fee />
