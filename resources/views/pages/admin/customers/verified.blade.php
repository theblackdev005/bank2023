            ...
            <div class="row">
                <div class="col-md-12 bg-white p-4 table-responsive">
                    <h1 class="mb-5">
                        ...
                        <span class="badge bg-success text-white">actifs</span>
                    </h1>
                    <table class="table">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="col-lg-1 text-center"><i class="fa fa-paperclip"></i></th>
                        ...
                        <tbody>
                            @forelse ($customers as $customer)
                                ...
                                <x-admin-customer-listing-row :customer=$customer/>
